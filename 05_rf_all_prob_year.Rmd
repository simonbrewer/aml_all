---
title: "ALL dataset - rf plots (transplant year added)"
knit: (function(input_file, encoding) {
  out_dir <- 'docs';
  rmarkdown::render(input_file,
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, 'rf_all_year_predict.html'))})
author:
...
all.df <- all.df %>%
  select(rbin, sex, txage, tyear, ## ADDED tyear

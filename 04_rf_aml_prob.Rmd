---
title: "AML dataset - rf plots (probability only)"
knit: (function(input_file, encoding) {
  out_dir <- 'docs';
  rmarkdown::render(input_file,
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, 'rf_aml_predict.html'))})
author:
...
myvars <- c("txage", "sex", "rstatprtx", "hla", "ghgp", "tbi",
            "bmc_cdw", "bmc_cd3", "bmc_cd15", "bmc_cd34",

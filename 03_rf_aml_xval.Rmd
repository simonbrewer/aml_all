---
title: "AML chimerism dataset - xvalidation `ranger` with **mlr3**"
knit: (function(input_file, encoding) {
  out_dir <- 'docs';
  rmarkdown::render(input_file,
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, 'rf_aml_xvalid_mlr3.html'))})
author:
...
gr = po(lrn_rf) %>>%
  po("threshold", param_vals = list(thresholds = 0.25))
